...
const ContactMe = () => {
  ...
  return (
    <div className="relative overflow-hidden">
      <div className="py-[64px] relative z-10">
        {/* Header div */}
        <div>
        ...
        <div>
          ...
          >
            ...
            <button className="btn bg-[#12F7D6] rounded-full text-xl font-medium border-none text-[#292F36] mt-16 hover:scale-110 transition-all duration-300">
              Send Message
      ...
      <div className="absolute inset-0 w-full h-full bg-[#292F36] -z-10"></div>
      {/* Background layer div */}
    </div>
  );
};
